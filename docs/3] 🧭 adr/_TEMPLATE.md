...
> Copy this file to `docs/adr/NNNN-kebab-title.md`, increment the number, fill in.
> An ADR is **frozen once accepted**. It records what we decided *and the context at that moment*. Don't edit accepted ADRs to reflect new reality — write a new ADR that supersedes the old one.
